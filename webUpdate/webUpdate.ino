...
//if you use actual domain, mDNS might be necessary to resolve
//need to use s3 bucket object address
#define HOST "https://s3.eu-west-2.amazonaws.com/customacoustical.com/Blink.ino.bin"

HTTPClient client;
// Your WiFi credentials
//const char* ssid = "FC70 Hyperoptic 1Gb Fibre 2.4Ghz";
//const char* password = "u5D5RjpHE6jr";
const char* ssid = "FC70 Hyperoptic 1Gb Fibre 2.4Ghz";
const char* password = "u5D5RjpHE6jr";
// Global variables
