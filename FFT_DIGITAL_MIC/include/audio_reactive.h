...
// check if this is A weighting - if not, maybe just A weight it! 
...
void setupAudio() {
  ...
  const i2s_config_t i2s_config = {
    ...
    //.channel_format = I2S_CHANNEL_FMT_ONLY_LEFT,        // LEFT when pin is tied to ground. *** MINE SEEMS TO BE FLIPPED NOT SURE WHAT I DID
  ...
  //esp_err_t result = i2s_read(I2S_NUM_0, &samples, BLOCK_SIZE, &num_bytes_read, portMAX_DELAY);
  ...
  // 8 comes from number of buffers
